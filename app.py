...
def backgroundworker3_ddviz(text, init_date, index_date, response_url, channel_id):
    ...
    def single(key, geo, cat, startdate, index, indexdate, font_use, out_type):
        ...
        df_key = df_raw[
            (df_raw.keyword == f'{params.get("key")}')
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="lines",
                opacity=0.3,
                line=dict(color="#024D83", width=4),
                showlegend=True,
            )
        )
        ...
        fig.update_layout(
            xaxis={
                "title": None,
                "titlefont": {"color": "#BFBFBF", "family": font_use},
                "tickfont": {"color": "#002A34", "size": 30, "family": font_use},
                "gridcolor": "#4A4A4A",
                "linecolor": "#000000",
                "showgrid": False,
            },
            yaxis={
                ...
                "titlefont": {"color": "#002A34", "size": 50, "family": font_use},
                "tickfont": {"color": "#002A34", "size": 30, "family": font_use},
                "showgrid": False,
                "zeroline": False,
            },
            margin={"l": 170, "b": 150, "t": 150, "r": 40},
            title={
                "text": f"{text}".capitalize(),
                "font": {"color": "#000000", "size": 40, "family": font_use},
                "yanchor": "top",
                "xanchor": "center",
            },
            legend={
                "font": {"size": 20, "color": "#333", "family": font_use},
                "yanchor": "top",
                "xanchor": "center",
                "y": 0.9,
                "x": 0.95,
    ...
    # payload is required to to send second message after task is completed
    payload = {"text": "your task is complete", "username": "bot"}
